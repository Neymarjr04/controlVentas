...
let reportData = {
  ventas: [
    ...
    { fecha: "2024-08-03", ventas: 0, ingresos: 0.75 },
    { fecha: "2024-08-04", ventas: 0, ingresos: 0.0 },
    { fecha: "2024-08-05", ventas: 0, ingresos: 0.3 },
    { fecha: "2024-08-06", ventas: 0, ingresos: 0.9 },
    { fecha: "2024-08-07", ventas: 0, ingresos: 0.45 },
  ],
  metodosPago: [
    { metodo: "Efectivo", cantidad:0 , porcentaje:0 },
    { metodo: "Tarjeta", cantidad:0 , porcentaje:0 },
    { metodo: "Yape", cantidad:0 , porcentaje:0 },
    { metodo: "Plin", cantidad:0 , porcentaje:0 },
  ],
  productosMasVendidos: [
    { nombre: "Coca Cola 500ml", cantidad: 0, ingresos: 0 },
    { nombre: "Pan Integral", cantidad: 0, ingresos: 0 },
    { nombre: "Leche Gloria UHT", cantidad: 0, ingresos: 0 },
    { nombre: "Aceite Primor 1L", cantidad: 0, ingresos: 0 },
    { nombre: "Detergente Ariel", cantidad: 0, ingresos: 0 },
  ],
  categorias: [
    { categoria: "Abarrotes", ventas:0, ingresos: 0, porcentaje:0 },
    { categoria: "Bebidas", ventas:0, ingresos: 0, porcentaje:0 },
    { categoria: "Limpieza", ventas:0, ingresos: 0, porcentaje:0 },
    { categoria: "Snacks", ventas:0, ingresos: 0, porcentaje:0 },
    { categoria: "Lácteos", ventas:0, ingresos: 0, porcentaje:0 },
  ],
};
